...
if (info == 'Price drop'):
    ...
    "personalizations": [
        ...
        "to": [
            {
            "email": "ziyou.foo.2022@scis.smu.edu.sg"
            }
        ],
    ...
    "from": {
        "email": "ondehhotel@gmail.com"
    },
    "content": [
        {
        "type": "text/plain",
        "value": "testing for esd :-)"
        }
    ]
    }
...
# sg = sendgrid.SendGridAPIClient(api_key=os.environ.get('SENDGRID_API_KEY'))
# from_email = Email("ziyou.foo.2022@scis.su.edu.sg")  # Change to your verified sender
# to_email = To("foo_zy@hotmail.com")  # Change to your recipient
# subject = "Sending with SendGrid is Fun"
